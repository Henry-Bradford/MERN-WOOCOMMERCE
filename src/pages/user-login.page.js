            ...
            <div className="container mx-auto px-4 h-full">
                ...
                <div className="w-full lg:w-4/12 px-4">
                    ...
                    <div className="rounded-t mb-0 px-6 py-6">
                        ...
                        <button
                            className="bg-white active:bg-blue-50 text-blue-700 font-normal px-4 py-2 rounded outline-none focus:outline-none mr-2 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs ease-linear transition-all duration-150"
                            type="button"
                        >
                            <img
                            alt="..."
