        ...
        <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-blue-500 mb-3">
            <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                ...
                <ul className="flex flex-col lg:flex-row list-none ml-auto">
                    ...
                    <li className="nav-item">                       
                        <Link className="nav-link px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" to={"/customers"}>Customers</Link>                        
                    </li>
                    <li className="nav-item">                       
                        <Link className="nav-link px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" to={"/rep-management"}>Rep Management</Link>                        
                    </li>
                    <li className="nav-item">                       
